...
<html>
  <head>
    ...
    <title>Home | Literary Loom</title>
  ...
  <body>
    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container"><a href="bookplanet.php" class="navbar-brand"><img id ="logo-img" src="images/logo.png" alt="" ></a>
          <button type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler navbar-toggler-right">Menu<i class="fa fa-bars ml-2"></i></button>
          <div id="navbarSupportedContent" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              <!-- Link-->
              <li class="nav-item" > <a href="index.html" class="nav-link active" style="color:#B7A4BF !important;"><i class="fas fa-sign-in-alt mr-2">
              </i>Welcome,
      ...
      <div class="container mb-5">
        <div class="row align-items-center">
          <div class="col-lg-5">
            ...
            <div class="row">
              <div class="col-lg-10">
                <p class="lead text-muted mt-4 mb-4"> Unlock the World of Knowledge: Your One-Stop Bookstore!</p>
              </div>
            </div>
          </div>
          <div class="col-lg-7"><img src="images/book.png" alt="..." class="hero-image img-fluid d-none d-lg-block"></div>
        </div>
      </div>
    </section>
    ...
    <div class="ads-grid py-sm-5 py-4" style="margin-top:-6%">
      <div class="container py-5">
        ...
        <header class="text-center mb-5">
          <h1 class="display-4 font-weight-bold">Dive into a Wonderland of Words:
          </h1>
          <br>
          <p  class="font-italic text-muted mb-0">Discover Our Spectacular Selection of Books!
        </header>
        <!-- Start First Row [Books]-->
        <h2 id="poetry" class="font-weight-bold mb-2">Poetry
        </h2>
        <p class="font-italic text-muted mb-4">where words dance, emotions sing, and hearts find solace in the rhythm of verse.
        </p>
        ...
        <p class="font-italic text-muted mb-4">Where every page is a pulse-pounding adventure, and every chapter leaves you on the edge of your seat.
        </p>
        <div class="row pb-5 mb-4">
          <!-- Start Book Card -->
          <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
        ...
        <p class="font-italic text-muted mb-4">Unveiling the tapestry of our past, illuminating the pathways to our present, and guiding us towards a brighter future.
        </p>
        <div class="row pb-5 mb-4">
          <!-- Start Book Card -->
          <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
        ...
        <p class="font-italic text-muted mb-4">Tiny portals to vast worlds, where every word is a journey and every ending is a new beginning.
        </p>
        <div class="row pb-5 mb-4">
          <!-- Start Book Card -->
          <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
    ...
    <section>
      <div class="container py-5">
      <h2 class="font-weight-bold mb-2">Literary Loom
      </h2>
      <p class="font-italic text-muted mb-4">“Reading a book is like opening a door to endless possibilities, where imagination knows no bounds and knowledge is the key to unlocking new horizons.”</p>
      <div class="row pb-5">
        <div class="col-lg-3 col-md-6 mb-4 mb-lg-0">
          <!-- Card-->
          <div class="card rounded shadow-sm border-0">
    ...
    <!-- Divider Section-->
    <section class="bg-primary text-white"style=" background-color: #B7A4BF !important">
      <div style="margin-left:125px; background-color: #B7A4BF !important">
          <!-- footer categories -->
          <div class="col-md-12 col-sm-12 footer-grids ">
            ...
            <ul style="list-style-type: none;">
              <li class="mb-3">
                ...
                </i>&nbsp;&nbsp; Location: Dr V P G Halkatti BLDEA's college of Engineering.  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <a style="color:white!important;"href="mailto:example@mail.com">&nbsp;&nbsp;Email: admin@ll.ml
                </a>
              </li>
            </ul>
          </div>
    ...
    <footer class="main-footer" style="background-color: #B7A4BF !important">
      <div class="container">
        <div class="row">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 text-center text-lg-left">
              <p class="copyrights-text mb-3 mb-lg-0">&copy; Literary Loom <span id="year"></span>. All rights reserved. </p>
