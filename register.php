...
background: scroll center url('images/book.png');
     ...
     <div class="row">
       <div class="col-lg-10 col-xl-9 mx-auto">
         <div class="card card-signin flex-row my-5">
           ...
           <div class="card-body">
             <h5 class="card-title text-center">Register To Literary Loom</h5>
             <form class="form-signin" action="registered.php" method="post">
               ...
               <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" style =" background-color: #B7A4BF!important"><i class="fas fa-user-plus mr-2"></i>Register</button>
             </form>
             <div class="form-signin">
               <hr class="my-4">
               <button onclick="window.location.href = 'index.php';" class="btn btn-lg btn-google btn-block text-uppercase" type="submit" style =" background-color: #B7A4BF!important"><i class="fas fa-sign-in-alt mr-2"></i> Login</button>
             </div>
           </div>
         </div>
       </div>
