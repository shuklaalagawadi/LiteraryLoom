...
<head>
	<title>Literarcy Loom| Contact Us</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light py-3">
        <div class="container">
            ...
            <a href="#" class="navbar-brand">
                <img src="images/logo.png" alt="logo" width="230">
            </a>
        </div>
    </nav>
</header>
            ...
            <form action="querysent.php" method="post">
                <div class="row">
                    ...
                    <div class="form-group col-lg-12 mx-auto mb-0">
											<center> <input type="submit" value="Submit Your Question" class="btn btn-primary btn-block py-2" style="background-color:#B7A4BF !important;"> </center>
                    </div>
